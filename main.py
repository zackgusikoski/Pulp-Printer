...
compression = ["Standard", "Linear", "Cubic", "Nearest", "Area", "Lanczos"]

PAINT_DROP_SIZE = 15 #mm^2
FEED_RATE = 400
FLOW_RATE = 400
FLOW_STEP = 1 #mm
DROPLETS = 2 #number of droplets deposited per dot
DELAY = 0.01 #delay between droplet deposition (seconds)
SHEET_SIZE = "A1"
IMAGE = "test_image17.jpg"
COMPRESSION_TYPE = compression[3]
COLOR1 = [0, 0, 0]#[140, 120, 100]
COLOR2 = [255, 255, 0]#[180, 150, 120]    # TODO write the section that pulls color suggestions (it will help to view how palette effects the result)
COLOR3 = [255, 0, 0]#[255, 255, 150]
